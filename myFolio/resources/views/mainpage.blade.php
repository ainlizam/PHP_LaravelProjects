...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url(assets/img/ain-bg.jpg)">
    <div class="overlay-itro"></div>
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          <!--<p class="display-6 color-d">Hello, world!</p>-->
          <h1 class="hero-title mb-4">I am Nur Ain Lizam</h1>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="assets/img/ain-formal.jpg" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span>Nur Ain Lizam</span></p>
                        <p><span class="title-s">Profile: </span> <span>full stack developer</span></p>
                        <p><span class="title-s">Email: </span> <span>ainlizam02@gmail.com</span></p>
                ...
                <div class="col-md-6">
                  <div class="about-me pt-4 pt-md-0">
                    ...
                    <p class="lead">
                        I'm a 3rd year degree student in Information Technology which specialized at Business Intelligence Analyst and minor Information Assurance Security at IIUM.
                        I'm eager to collaborate and build connections to explore deeply towards my self interest field which is about data analyst, Information systems management and front-end development
                    </p>
                    <p class="lead">
                        My biggest aim right now is to widen my view, perspective, learn new things and improve myself, where to achieve that, I need to have a connection with the person from any expertise as wide as I could especially in the IT field.
                        I believe this is one way for me to keep motivated along my degree life journey later.
                    </p>
